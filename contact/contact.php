	   ...
	   <div id="general-info">
   		...
   		<div id="contact-email" class="right">
	   		...
	   		<div class="field name-box">
		        ...
		        <span class="error"><?php if ($request == "POST" && empty($_POST["name"])){$name = setName($_POST["name"]);}?></span>
	      	</div>
	      	<div class="field name-box">
		        <input type="text" id="phone" name="phone" placeholder="Ex:(333)456 7890"/>
        		<label for="name">Phone</label>
		        <span class="glyphicon-ok"></span>
		        <span class="error"><?php if ($request == "POST" && empty($_POST["phone"])){$name = setName($_POST["phone"]);}?></span>
	      	</div>
		      ...
		      <div class="field email-box">
			        ...
			        <span class="glyphicon-ok"></span>
			        <span class="error"><?php if ($request == "POST" && empty($_POST["email"])){$email = setEmail($_POST["email"]);}?></span>
		      </div>
	      ...
	      <div class="field msg-box">
		        ...
		        <span class="glyphicon-ok"></span>
		        <span class="error"><?php if ($request == "POST" && empty($_POST["message"])){$message = setMessage($_POST["message"]);}?></span>
	      </div>
		  <div id="send">
